...
const chainLogoConfig: Record<AppKitChain, ChainLogoConfig> = {
  ...
  Base_Sepolia: { label: "Base Sepolia", className: "bg-white text-[#0052ff] ring-[#0052ff]/20", icon: BaseMark },
...
function BaseMark(props: ChainMarkProps) { return <svg viewBox="0 0 32 32" fill="none" aria-hidden="true" {...props}><circle cx="16" cy="16" r="15.5" fill="#fff"/><rect x="8" y="8" width="16" height="16" rx="4.4" fill="#0052ff"/></svg>; }
